    ...
    public static class Program
    {
        static void Main(string[] args)
        {
            ...
            while (userWantsToPlay)
            {
                ...
                remainingCredits = UIMethods.PrintBalanceAfterBet(userCredits, betAmount);
                ...
                int moneyWon = UIMethods.PrintBalanceAfterRound(remainingCredits, winningRowCount);
                userCredits = moneyWon;
